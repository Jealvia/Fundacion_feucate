...
public class MotivoAdapter extends ArrayAdapter<Motivo> {
    ...
    private List<Motivo> mItems;

    public MotivoAdapter(@NonNull Context context, @NonNull List<Motivo> items) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View view;
        Motivo motivo = mItems.get(position);
        ...
        textView.setText(motivo.getMotivoNombre());
    ...
    public List<Motivo> getmItems() {
        return mItems;
    }

    public void setmItems(List<Motivo> mItems) {
        this.mItems = mItems;
    }
